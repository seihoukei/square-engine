import SquarePointer from "../../../square-engine/pointer/square-pointer.js"

export default class MapActivity extends SquarePointer.Activity {
	name = "Map"
	defaultState = "Empty"
	...
	build() {
		...
		this.addActions({
			cell_action(input) {
				...
				this.scenario.updateNodesData()
				this.scenario.updateRegionsData()
